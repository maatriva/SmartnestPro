      ...
      bg-[var(--bg-glass)] backdrop-blur-xl border border-white/40 shadow-[var(--shadow)]">
        ...
        <ul className="flex items-center gap-8 font-semibold">
          <li className="nav-item">
            <Link to="/" className="nav-link inline-block hover:text-[var(--text-dark)] transition duration-200">Home</Link>
          </li>
          {["Survey", "About Us", "Diseases"].map((text, i) => (
        ...
        <div className="flex items-center gap-4 nav-cta">
          {user ? (
